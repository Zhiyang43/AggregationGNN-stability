        ...
        for batch in range(nBatches):
            ...
            for key in modelsDict.keys():
                ...
                if 'singleNodeForward' in dir(modelsDict[key].archit):
                    ...
                    yHatTrain, _= modelsDict[key].archit(xTrain)
                ...
                if "NoPel" in key:
                    ...
                    lossValueTrain, mainLossValueTrain, penaltyValueTrain  = modelsDict[key].loss(yHatTrain, yTrain)
                ...
                for key in modelsDict.keys():
                    ...
                    with torch.no_grad():
                        ...
                        if 'singleNodeForward' in dir(modelsDict[key].archit):
                            ...
                            yHatValid,_  = modelsDict[key].archit(xValid)
                        ...
                        # Compute loss
                            ...
                            lossValueValid,_ , _ = modelsDict[key].loss(yHatValid, yValid)
